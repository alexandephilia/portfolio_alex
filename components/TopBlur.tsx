            ...
            <div className="relative w-full h-full bg-none">
                ...
                */}
                ...
                <div style={{
                    ...
                    maskImage: 'linear-gradient(to top, rgba(0,0,0,0) 87.5%, rgba(0,0,0,1) 100%, rgba(0,0,0,1) 112.5%, rgba(0,0,0,0) 125%)',
                    WebkitMaskImage: 'linear-gradient(to top, rgba(0,0,0,0) 87.5%, rgba(0,0,0,1) 100%, rgba(0,0,0,1) 112.5%, rgba(0,0,0,0) 125%)'
                }} />
            </div>
        </div>
    );

...
const ContactSection: React.FC = () => {
    return (
        <div className="flex flex-col h-full w-full">
            {/* Main Content Centered - transform-style flat prevents 3D tilt from affecting hover detection */}
            <div className="flex-1 flex flex-col items-center justify-center py-6 gap-3 md:gap-3 w-full" style={{ transformStyle: 'flat' }}>

    ...
    >
      <ShimmerButton className="w-full">
        <motion.div
          ref={cardRef}
          whileHover={{ 
            boxShadow: "0 0 30px rgba(0, 113, 169, 0.3)"
          }}
          transition={{ duration: 0.3 }}
          className="w-full"
        >
          <Card className="overflow-hidden w-full bg-white dark:bg-black/100 
            border-[2px] border-[#0071a9]/[0.15] dark:border-white/[0.08] 
            group-hover:border-[#0071a9]/40 dark:group-hover:border-white/[0.2] 
            ring-1 ring-[#0071a9]/[0.05] dark:ring-white/[0.05] shadow-sm group-hover:shadow-[0_0_20px_rgba(0,113,169,0.2)] dark:group-hover:shadow-[0_0_20px_rgba(255,255,255,0.15)]
                    ...
                    <div className="flex-1 space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full rounded-md border bg-white/[0.1] dark:bg-black/100 border-[#0071a9]/[0.15] dark:border-white/10 
                          ...
                          focus:outline-none focus:ring-1 focus:ring-[#0071a9]/10 dark:focus:ring-zinc-700/20 transition-all"
                        required
                      />
                    </div>
                    <div className="flex-1 space-y-1.5">

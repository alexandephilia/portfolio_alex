              ...
              subtitle={
                <div className="flex flex-col items-center text-center gap-2 dark:text-white dark:drop-shadow-[0_0_0.3rem_#ffffff70] max-w-[340px] sm:max-w-none mx-auto">
                  <p className="flex flex-wrap items-center justify-center gap-1.5 text-[11px] md:text-sm lg:text-base">
                    <strong>Navigating code landscapes with </strong>
                    <motion.span
                    ...
                    <motion.span
                      ...
                      transition={{ type: "spring", stiffness: 400, damping: 10 }}
                    >
                      <SiLinux className="w-3 h-3 md:w-3.5 md:h-3.5 text-yellow-500 dark:text-yellow-400" />
                      <span className="text-[9px] md:text-xs text-yellow-500 dark:text-yellow-400">Linux</span>
                    </motion.span>
                    ...
                    >
                      ...
                      <span className="text-[9px] md:text-xs text-purple-500 dark:text-purple-400">Prompt</span>
                    </motion.span>
                    <strong>— while contemplating the elegance of open-source philosophy.</strong>
                  </p>
                </div>
              }

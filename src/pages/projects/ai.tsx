...
const TerminalWindow = ({ children }: { children: React.ReactNode }) => (
    <div className="rounded-lg bg-background/40 backdrop-blur-sm overflow-hidden relative transition-all duration-300 
        border-[1px] border-[#0f73a8]/[0.15] dark:border-white/[0.08] 
        hover:border-[#0f73a8]/25 dark:hover:border-white/[0.15] 
        ring-1 ring-[#0f73a8]/[0.05] dark:ring-white/[0.05] 
        shadow-sm hover:shadow-[0_0_15px_rgba(15,115,168,0.1)] dark:hover:shadow-[0_0_15px_rgba(255,255,255,0.1)]">
        <div className="h-8 flex items-center px-4 bg-muted/30 backdrop-blur-sm transition-colors duration-300
            border-b border-[#0f73a8]/[0.15] dark:border-white/[0.08]">
                                ...
                                >
                                    ...
                                    >
                                        <ShimmerButton className="w-full h-full group">
                                            <Card className="relative flex flex-col h-[300px] md:h-[280px] cursor-pointer transition-all duration-500 ease-out dark:bg-black/100 bg-white/[0.1] rounded-lg 
                                                border-[1px] border-[#0f73a8]/[0.15] dark:border-white/[0.08] 
                                                hover:border-[#0f73a8]/25 dark:hover:border-white/[0.15] 
                                                ring-1 ring-[#0f73a8]/[0.05] dark:ring-white/[0.05] 
                                                shadow-sm hover:shadow-[0_0_15px_rgba(15,115,168,0.1)] dark:hover:shadow-[0_0_15px_rgba(255,255,255,0.1)]">

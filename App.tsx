...
import IdentitySection, { IdentityOverlay } from './components/sections/IdentitySection';
                ...
                >
                    ...
                    <div className="absolute inset-0 w-full h-full flex items-center justify-center perspective-container z-10">
                        ...
                        {!isLoading && (
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <IdentitySection mouseX={mouseXSpring} mouseY={mouseYSpring} />
                                    </TicketCard>
                                </motion.div>
                            </motion.div>
                        )}
                        ...
                        <motion.div
                            ...
                            className="pointer-events-none absolute inset-0 w-full h-full flex items-center justify-center"
                        >
                            <TicketCard
                                index={1}
                                scrollProgress={currentCardProgress}

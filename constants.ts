...
export const SERVICES = [
  { 
    ...
    detail: "LEVERAGING ADVANCED MCPS AND AUTONOMOUS AGENTS TO REDUCE DEVELOPMENT CYCLES BY 90%. I BUILD EVOLVING SYSTEMS THAT CAN BE WRITE, TEST, AND DEPLOY CODE WITH MAINTAINED.",

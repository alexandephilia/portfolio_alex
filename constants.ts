...
export const SERVICES = [
  ...
  { 
    ...
    detail: "WE PRIORITIZE ARCHITECTURE OVER SPECIFIC TOOLS. BY MAINTAINING A FLEXIBLE TECH STACK, WE ENSURE YOUR INFRASTRUCTURE SCALES ADAPTIVELY, INTEGRATING THE BEST-IN-CLASS SOLUTIONS FOR EACH UNIQUE CHALLENGE.",
  ...
  { 
    ...
    detail: "RAPID PROTOTYPING METHODOLOGIES DESIGNED TO EXPOSE CRITICAL FLAWS IMMEDIATELY. WE ITERATE THROUGH FAILURE STATES AT HIGH SPEED TO CLEAR THE PATH FOR A ROBUST, PRODUCTION-READY SOLUTION.",
    tools: ["DEVTOOL MPC", "AI DEBUGGING", "JEST", "CYPRESS"]
  },
];